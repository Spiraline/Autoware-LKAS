...
cs1_state.transform.position = spawns[0].position + 485 * forward - 30 * right
...
cs1_wp2 = lgsvl.DriveWaypoint(position=lgsvl.Vector(cs1_end.x, cs1_end.y, cs1_end.z), speed=1,
...
cs1_wp3 = lgsvl.DriveWaypoint(position=lgsvl.Vector(cs1_dump.x, cs1_dump.y, cs1_dump.z), speed=cs_speed,
...
cs2_state.transform.position = spawns[0].position + 481 * forward - 55 * right
...
cs2_wp2 = lgsvl.DriveWaypoint(position=lgsvl.Vector(cs2_end.x, cs2_end.y, cs2_end.z), speed=1,
                              angle=cs_angle, idle=100, trigger_distance=0, trigger=None)
...
cs2_wp3 = lgsvl.DriveWaypoint(position=lgsvl.Vector(cs2_dump.x, cs2_dump.y, cs2_dump.z), speed=cs_speed,
                              angle=cs_angle, idle=0, trigger_distance=0, trigger=None)
...
ci1_wp4 = lgsvl.DriveWaypoint(position=lgsvl.Vector(ci1_end.x, ci1_end.y, ci1_end.z), speed=1,
                              angle=ci_angle, idle=100, trigger_distance=0, trigger=None)
ci1_waypoints.append(ci1_wp4)

ci1_dump = ci1_end + 5000 * right
...
ci2_wp4 = lgsvl.DriveWaypoint(position=lgsvl.Vector(ci2_end.x, ci2_end.y, ci2_end.z), speed=1,
                              angle=ci_angle, idle=10, trigger_distance=0, trigger=None)
ci2_waypoints.append(ci2_wp4)

ci2_dump = ci2_end + 5000 * right
...
npc1_s1_state.transform.position = spawns[0].position + 475 * forward - 650 * right
...
npc1_wp1 = lgsvl.DriveWaypoint(position=lgsvl.Vector(npc1_s1_start.x, npc1_s1_start.y, npc1_s1_start.z),
                               speed=npc_speed, angle=npc_s1_angle, idle=3, trigger_distance=80, trigger=None)
npc1_s1_waypoints.append(npc1_wp1)

#set npc_s1_vehicle1's waypoint2
npc1_s1_way1 = npc1_s1_start + 45 * right
...
npc_s1_angle1 = lgsvl.Vector(0, 0, 0)

#set npc_s1_vehicle1's waypoint3
npc1_s1_way2 = npc1_s1_way1 + 10 * forward
npc1_s1_wp3 = lgsvl.DriveWaypoint(position=lgsvl.Vector(npc1_s1_way2.x, npc1_s1_way2.y, npc1_s1_way2.z),
                                  speed=npc_speed, angle=npc_s1_angle1, idle=0, trigger_distance=0, trigger=None)
npc1_s1_waypoints.append(npc1_s1_wp3)

#set npc_s1_vehicle1's waypoint4
npc1_s1_way3 = npc1_s1_way2 + 100 * forward
npc1_s1_wp4 = lgsvl.DriveWaypoint(position=lgsvl.Vector(npc1_s1_way3.x, npc1_s1_way3.y, npc1_s1_way3.z),
                                  speed=1, angle=npc_s1_angle1, idle=0, trigger_distance=0, trigger=None)
npc1_s1_waypoints.append(npc1_s1_wp4)

#set npc_s1_vehicle1's waypoint5
npc1_s1_way4 = npc1_s1_way3 + 5000 * forward
npc1_s1_wp5 = lgsvl.DriveWaypoint(position=lgsvl.Vector(npc1_s1_way4.x, npc1_s1_way4.y, npc1_s1_way4.z),
                                  speed=npc_speed, angle=npc_s1_angle1, idle=0, trigger_distance=0, trigger=None)
npc1_s1_waypoints.append(npc1_s1_wp5)

#set npc_s1_vehicle1
npc_s1_vehicle1 = sim.add_agent("Sedan", lgsvl.AgentType.NPC, npc1_s1_state)
npc_s1_vehicle1.follow(npc1_s1_waypoints, loop=True)


npc2_s1_state = lgsvl.AgentState()
npc2_s1_state.transform.position = spawns[0].position + 470 * forward - 650 * right
...
npc2_s1_wp1 = lgsvl.DriveWaypoint(position=lgsvl.Vector(npc2_s1_start.x, npc2_s1_start.y, npc2_s1_start.z),
                                  speed=npc_speed, angle=npc2_s1_angle, idle=9, trigger_distance=80, trigger=None)
...
npc_s1_vehicle2.follow(npc2_s1_waypoints, loop=True)
...
npc1_s2_state.transform.position = spawns[0].position + 510 * forward - 615 * right
